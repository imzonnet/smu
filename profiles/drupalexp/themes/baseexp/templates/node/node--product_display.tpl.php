...
<div id="node-<?php print $node->nid; ?>" class="product-content <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
    <div class='row'>
        ...
        <div class="shop-left col-lg-6 col-md-6 col-sm-12 col-xs-12 product-thumbnails">
            <?php print render($content['product:field_product_images']);?>
        </div>
        
        <div class="shop-right col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class='title'>
            ...
            <?php print render($content['field_product']);?>
					<div class="product-meta clearfix">
							...
							<?php print render($content['field_product_catelog']);?>
					</div>
       </div>
    </div>
