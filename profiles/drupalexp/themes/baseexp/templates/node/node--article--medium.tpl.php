...
<div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div class="blog-media media_element col-xs-12 col-sm-12 col-md-4 col-lg-4">
  ...
  <div class="blog-detail blog-custom col-xs-12 col-sm-12 col-md-8 col-lg-8">
		<div class="date">
			<h3><div class="border"><?php print format_date($created, 'custom', 'd');?></div></h3>
		...
		<div class="blog-content">
			...
			<div class="post_more">
				<div class="post_meta">
					 ...
					 <span><i class="fa fa-calendar"></i><?php print format_date($created, 'custom', 'd M y');?></span>
				...
				<div class="view-detail"><a href="<?php print $node_url;?>" class="readmore btn btn-primary"><?php print t('Read more'); ?></a></div>
			</div>
		</div>
  </div>
